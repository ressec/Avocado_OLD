...
final class TestImageHelper extends BaseUnitTest
{
    ...
    @Test
    @DisplayName("Should save icon as PNG in the test folder")
    ...
    @Test
    @DisplayName("Should save and resize icon as PNG in the test folder")
    ...
    @Test
    @DisplayName("Should save icon as BMP in the test folder")
    ...
    @Test
    @DisplayName("Should save and resize icon as BMP in the test folder")
    ...
    @Test
    @DisplayName("Should save icon as GIF in the test folder")
    ...
    @Test
    @DisplayName("Should save and resize icon as GIF in the test folder")
    ...
    @Test
    @DisplayName("Should save icon as JPG in the test folder")
    ...
    @Test
    @DisplayName("Should save and resize icon as JPG in the test folder")
    ...
    @Test
    @DisplayName("Should save icon as TIFF in the test folder")
    ...
    @Test
    @DisplayName("Should save and resize icon as TIFF in the test folder")
